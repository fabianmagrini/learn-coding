...
export function RewriteOutput({ rewrittenText, isLoading, error }: RewriteOutputProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium text-gray-900">Rewritten Text</h3>
      ...
      <div className="min-h-40 p-4 border border-gray-300 rounded-md bg-gray-50">
        {isLoading && (
          <div className="flex items-center space-x-2 text-gray-600">
            ...
            <span className="text-sm">Rewriting text...</span>
          </div>
        )}
        ...
        {!rewrittenText && !isLoading && (
          <p className="text-gray-500 text-sm italic">
            Your rewritten text will appear here once generated.
          </p>
        )}
      </div>
    </div>
